...
const Exams = () => {
  ...
  return (
    <section>
      <div className="font-medium mb-5 text-[#006565] text-5xl">Exam 1</div>
      <div className="flex justify-end mb-2 pr-8">
        ...
        <div className="flex items-center ml-4">
          ...
          <p className="ml-2 text-2xl">65</p>
        </div>
      </div>
      <div className="flex justify-evenly p-8">
        <div className="h-full  min-h-[800px]w-2/3 min-w-[600px] bg-black mb-10 rounded-lg p-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center h-3/4 justify-around">
