'use client'
import Cookies from 'js-cookie';  // A library like js-cookie can help
...
const Exams = () => {
  ...
  const navigateToResultPage = () => {
    // Save results and time in cookies
    Cookies.set('results', JSON.stringify(results), { expires: 1 });  // Cookie valid for 1 day
    Cookies.set('time', String(seconds), { expires: 1 });
  
    router.push('/lessons/exam/result');
  };
