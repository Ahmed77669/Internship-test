    ...
    return (
        <section className={`px-4 text-black`}>
            ...
            <div className="flex justify-center mb-16">
                {myNumber === 3 ? (
                    <>
                        <StarIcon className="text-8xl fill-yellow-400 text-yellow-400 mr-16" />
                        <StarIcon className="text-8xl fill-yellow-400 text-yellow-400 mr-16" />
                        <StarIcon className="text-8xl fill-yellow-400 text-yellow-400" />
                    </>
                ) : myNumber === 2 ? (
                    <>
                        <StarIcon className="text-8xl fill-yellow-400 text-yellow-400 mr-16" />
                        <StarIcon className="text-8xl fill-yellow-400 text-yellow-400 mr-16" />
                        <StarIcon className="text-8xl text-gray-400 fill-gray-400" />
                    </>
                ) : myNumber === 1 ? (
                    <>
                        <StarIcon className="text-8xl fill-yellow-400 text-yellow-400 mr-16" />
                        <StarIcon className="text-8xl text-gray-400 fill-gray-400 mr-16" />
                        <StarIcon className="text-8xl text-gray-400 fill-gray-400" />
                    </>
                ) : (
                    <>
