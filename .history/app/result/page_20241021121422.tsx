...
const ResultPage = () => {
  ...
  return (
    <section className={`${poppins.className} px-4`}>
      <div className="text-3xl font-normal mb-12 text-teal-800">
        Result
      </div>
      ...
      <div className="flex justify-center mb-16">
        {
          myNumber == 3 ?
          <><Star className="text-8xl text-yellow-400 mr-16" /><Star className="text-8xl text-yellow-400 mr-16" /><Star className="text-8xl text-yellow-400" /></> :
          myNumber == 2 ?
          <><Star className="text-8xl text-yellow-400 mr-16" /><Star className="text-8xl text-yellow-400 mr-16" /><Star className="text-8xl text-gray-400" /></> :
          myNumber == 1 ?
          <><Star className="text-8xl text-yellow-400 mr-16" /><Star className="text-8xl text-gray-400 mr-16" /><Star className="text-8xl text-gray-400" /></> :
          <><Star className="text-8xl text-gray-400 mr-16" /><Star className="text-8xl text-gray-400 mr-16" /><Star className="text-8xl text-gray-400" /></>
        }
      </div>
