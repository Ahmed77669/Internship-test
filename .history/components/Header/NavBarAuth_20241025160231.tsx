      ...
      <nav className="relative">
        <ul className="flex justify-between items-center">
          <li className="min-w-[152px]">
            <Link href="/">
              <Image src={GT_logo} alt="Gammal Tech Logo" width={130} height={130} className="cursor-pointer" />
            </Link>
          </li>
                ...
                {isMenuOpen && (
                  ...
                  >
                    <div className="flex flex-col items-center justify-center min-h-screen p-4">
                      <button onClick={toggleMenu} className="absolute top-4 right-4 text-[#007676]" aria-label="Close menu">
                        <X size={40} color="#007676" strokeWidth={2} />
                      </button>
                      <nav className="w-full max-w-md">
                        <Link href="/" className="block text-[#007676] text-lg font-semibold hover:bg-[#f0f0f0] transition duration-200 p-3 rounded-lg text-center w-full" onClick={toggleMenu}>
                          Home
                        </Link>
                        <Link href="/pricing" className="block text-[#007676] text-lg font-semibold hover:bg-[#f0f0f0] transition duration-200 p-3 rounded-lg text-center w-full" onClick={toggleMenu}>
                          Pricing
                        </Link>
                        <Link href="#" className="block text-[#007676] text-lg font-semibold hover:bg-[#f0f0f0] transition duration-200 p-3 rounded-lg text-center w-full" onClick={toggleMenu}>
                          AI Challenge
                        ...
                        <Link href="/about" className="block text-[#007676] text-lg font-semibold hover:bg-[#f0f0f0] transition duration-200 p-3 rounded-lg text-center w-full" onClick={toggleMenu}>
                          About Us
                        </Link>
                        <button className="mt-4 bg-[#007676] text-white text-lg font-semibold py-2 px-6 rounded-lg hover:bg-[#005c5c] transition duration-200 w-full" onClick={toggleMenu}>
                          GET STARTED
                        </button>
                      </nav>
                    </div>
