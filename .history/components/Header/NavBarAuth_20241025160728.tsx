            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg z-20">
                  <div className="py-1">
                    <Link href="/profile" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => handleDropdownItemClick(() => {})}>
                      <User className="mr-2 h-4 w-4" />
                      <span>Profile</span>
                    </Link>
                    <Link href="/certificate" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => handleDropdownItemClick(() => {})}>
                      <Award className="mr-2 h-4 w-4" />
                      <span>Certificate</span>
                    </Link>
                    <button onClick={() => handleDropdownItemClick(handleLogout)} className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">
