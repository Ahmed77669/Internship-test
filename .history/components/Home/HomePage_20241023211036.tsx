  ...
  <section className="text-center relative">
    ...
    <div className="relative z-10 py-12">
      ...
      <div className="flex justify-center space-x-4">
        <Link href="/practice" className="bg-teal-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-teal-600 transition duration-300 inline-flex items-center">
