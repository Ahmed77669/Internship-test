  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const sortedData = data.sort((a: { total_points: number; }, b: { total_points: number; }) => b.total_points - a.total_points);
        setUsers(sortedData);
      } catch (error) {
              ...
              (exam, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-4">
                    Master the latest in {exam.toLowerCase()} technologies and
                    concepts.
                  </p>
                  <Link
                    href={`/exam/${exam.toLowerCase().replace(" ", "-")}`}
