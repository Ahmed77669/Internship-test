...
import userProfile from "@/public/account_data/dummy-photo.png"
          ...
          {[
            {
              ...
              description: "Personalized exam paths based on your performance",
            },
            {
              icon: Zap,
            ...
            },
            {
              icon: Target,
              title: "Goal Tracking",
              description: "Set and monitor your exam preparation goals",
            },
          ].map((feature, index) => (
            <div
              key={index}
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                title: "Perfect Score",
                description: "Scored 100% on any exam",
                unlocked: false,
              },
              {
              ...
              <div
                ...
                className={`p-4 rounded-lg ${
                  achievement.unlocked ? "bg-teal-100" : "bg-gray-100"
                }`}
              >
                <Award
                  className={`mb-2 ${
                    achievement.unlocked ? "text-teal-500" : "text-gray-400"
                  }`}
                  size={32}
                />
                <h3
              ...
              <tbody>
                {users.slice(0, 10).map((user, index) => (
                  ...
                  >
                    ...
                    <td className="p-3 font-semibold flex"> <Image src={userProfile} alt="userProfile" width={30} className="rounded-full ml-2" /><span>{user.name}</span></td>
              ...
              (exam, index) => (
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Join {Math.floor(Math.random() * 500 + 50)} learners in
                    mastering {exam}!
                  </p>
                  <Link
                    href="/lessons"
                    className="text-teal-600 hover:text-teal-800 font-semibold inline-flex items-center mt-4"
                  >
                    Start Now <ChevronRight className="ml-1" size={20} />
                  </Link>
                </div>
              )
            )}
