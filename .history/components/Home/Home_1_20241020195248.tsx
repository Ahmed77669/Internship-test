    ...
    return 0;
      ...
      <div className="mt-[12%] mb-[12%] py-20 min-h-[400px]">
        <div className="w-[92%] container mx-auto">
          ...
          <div className="flex flex-col xl:flex-row justify-between space-y-6 xl:space-y-0 items-center flex-wrap">
            {[coder1Image, coder2Image, coder3Image].map((coder, index) => (
              <Image
                key={index}
                src={coder}
                width={400}
