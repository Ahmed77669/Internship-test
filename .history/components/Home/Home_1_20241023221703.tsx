    ...
    <section className="mt-[10%]">
      <div className="w-[92%] container mx-auto flex flex-col xl:flex-row justify-between flex-wrap hero-section">
        <div className="w-full xl:w-[660px] mb-10 xl:mb-0">
          ...
          <button className="bg-[#007676] text-white rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-[#005555] hover:shadow-lg mt-6 md:mt-8" onClick={()=>{route.push('/HomePage')}}>
            GET STARTED
          </button>
        </div>
