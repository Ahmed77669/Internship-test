    ...
    <section className="mt-[10%]">
      <div className="w-[92%] container mx-auto flex flex-col xl:flex-row justify-between flex-wrap hero-section">
        <div className="w-full xl:w-[660px] mb-10 xl:mb-0">
          ...
          <button className="bg-[#007676] text-white rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-[#005555] hover:shadow-lg mt-6 md:mt-8" onClick={()=>{route.push('/Home_2')}}>
            GET STARTED
          </button>
        </div>
    ...
    return 0;
      ...
      <div className="bg-[#095051] mt-[12%] mb-[12%] py-36 min-h-[800px]">
        <div className="w-[92%] container mx-auto flex flex-col xl:flex-row justify-between">
          <div className="w-full xl:w-[700px] mb-10 xl:mb-0">
            ...
            <button className="bg-[#ffffff] text-[#007676] rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-opacity-95 hover:shadow-lg mt-6 md:mt-8" onClick={()=>{route.push('/Home_2')}}>
              Try it
            </button>
          </div>
      ...
      <div className="w-[92%] container mx-auto flex flex-col xl:flex-row justify-between mb-52">
        <div className="w-full xl:w-[700px] mb-10 xl:mb-0">
          ...
          <button className="bg-[#007676] text-[#ffffff] rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-opacity-95 hover:shadow-lg mt-6 md:mt-8" onClick={()=>{route.push('/Home_2')}}>
            Try it
          </button>
        </div>
      ...
      <div className="bg-[#095051] mt-[12%] mb-[12%] py-20 min-h-[400px]">
        <div className="w-[92%] container mx-auto">
          <div className="flex justify-center text-3xl md:text-4xl text-white mb-10 md:mb-10">
