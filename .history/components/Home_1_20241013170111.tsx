    ...
    <section className='mt-20'>
        <div className="w-[92%]  container mx-auto flex">
            <div>
                ...
                <button
              // onClick={() => route("/")}
              className="bg-[#007676] text-white rounded-md w-[156px] h-[50px] text-[16px] font-semibold  py-1 px-3 transition-all duration-300 ease-in-out hover:bg-[#005555] hover:shadow-lg mt-10"
            >
              GET STARTED
            </button>
            </div>
