...
<div className="w-[92%]  container mx-auto flex justify-between flex-wrap">
            <div className='w-[640px]'>
                ...
                <button
              // onClick={() => route("/")}
              className="bg-[#ffffff] text-[#007676] rounded-md w-[156px] h-[50px] text-[16px] font-semibold  py-1 px-3 transition-all duration-300 ease-in-out hover:opacity-5 hover:shadow-lg mt-8"
            >
              GET STARTED
            </button>
            </div>
