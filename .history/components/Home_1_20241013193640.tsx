...
int main() {
    ...
    return 0;
      ...
      <div className="bg-[#095051] mt-[12%] mb-[12%] py-36 h-[800px] content-end">
      ...
      <div className="w-[92%]  container mx-auto flex justify-between flex-wrap">
        <div className="w-[700px]">
          ...
          <p className="text-black w-2/3 text-xl mt-8 leading-[40px]">
            Enhance your skills with exams in over 30 programming languages. Our
            premium service offers a comprehensive and engaging way to advance
