...
import coder2 from '@/pu2lic/coders photos/coder2.jpg'
import coder3 from '@/pu3lic/coders photos/coder3.jpg'
  ...
  ></iframe>
      ...
      <div className="mt-[12%] mb-[12%] py-20 min-h-[400px] h-auto ">
        <div className="w-[92%]  container mx-auto">
          ...
          <div className="flex justify-between">
<Image src={coder1} width={400} alt="coder photo"/>
<Image src={coder2} width={400} alt="coder photo"/>
<Image src={coder3} width={400} alt="coder photo"/>
  {/* <iframe
    src="https://www.youtube.com/embed/W7vnW2IOP3c?si=oNy2TVfaQ5rSNn0G"
    width="360"
    height="280"
