  ...
  ></iframe>
      ...
      <div className="mt-[12%] mb-[12%] py-20 min-h-[400px] h-auto ">
        <div className="w-[92%]  container mx-auto">
          ...
          <div className="flex justify-between">
<Image src={coder1} width={400} alt="coder photo" className="rounded-xl transform transition-transform duration-300 hover:scale-110"/>
<Image src={coder2} width={400} alt="coder photo" className="rounded-xl transform transition-transform duration-300 hover:scale-110"/>
<Image src={coder3} width={400} alt="coder photo" className="rounded-xl transform transition-transform duration-300 hover:scale-110"/>
