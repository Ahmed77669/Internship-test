...
int main() {
    ...
    return 0;
      ...
      <div className="text-[#095051] font-medium text-5xl flex justify-center mb-16">
  ...
  ></iframe>
      ...
      <div className="mt-[12%] mb-[12%] py-20 min-h-[400px] h-auto ">
        <div className="w-[92%]  container mx-auto">
          <div className="flex justify-center text-4xl text-[#095051] mb-14 font-semibold">Meet Top Coders on the Final exams’s Website</div>
          <div className="flex justify-between">
<Image src={coder1} width={400} alt="coder photo" className="rounded-xl transform transition-transform duration-300 hover:scale-110 hover: cursor-pointer"/>
<Image src={coder2} width={400} alt="coder photo" className="rounded-xl transform transition-transform duration-300 hover:scale-110 hover: cursor-pointer"/>
<Image src={coder3} width={400} alt="coder photo" className="rounded-xl transform transition-transform duration-300 hover:scale-110 hover: cursor-pointer"/>
