    ...
    return 0;
      ...
      <div className="bg-[#095051] mt-[12%] mb-[12%] py-20 min-h-[400px]">
        <div className="w-[92%] container mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between space-y-6 lg:space-y-0 lg:space-x-5  flex-wrap">
      ...
      <div className="mt-[12%] mb-[12%] py-20 min-h-[400px]">
        <div className="w-[92%] container mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between space-y-6 lg:space-y-0 items-center flex-wrap">
