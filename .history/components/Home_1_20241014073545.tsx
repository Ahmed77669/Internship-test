    ...
    <section className="mt-[10%]">
      <div className="w-[92%] container mx-auto flex flex-col lg:flex-row justify-between flex-wrap hero-section">
        <div className="w-full lg:w-[660px] mb-10 lg:mb-0">
          ...
          <button className="bg-[#007676] text-white rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-[#005555] hover:shadow-lg mt-6 lg:mt-8">
            GET STARTED
          </button>
        </div>
    ...
    return 0;
      ...
      <div className="bg-[#095051] mt-[12%] mb-[12%] py-36 min-h-[800px]">
        <div className="w-[92%] container mx-auto flex flex-col lg:flex-row justify-between">
          <div className="w-full lg:w-[700px] mb-10 lg:mb-0">
            ...
            <button className="bg-[#ffffff] text-[#007676] rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-opacity-95 hover:shadow-lg mt-6 lg:mt-8">
              Try it
            </button>
          </div>
      ...
      <div className="w-[92%] container mx-auto flex flex-col lg:flex-row justify-between mb-52">
        <div className="w-full lg:w-[700px] mb-10 lg:mb-0">
          ...
          <button className="bg-[#007676] text-[#ffffff] rounded-md w-[156px] h-[50px] text-[16px] font-semibold py-1 px-3 transition-all duration-300 ease-in-out hover:bg-opacity-95 hover:shadow-lg mt-6 lg:mt-8">
            Try it
          </button>
        </div>
      ...
      <div className="bg-[#095051] mt-[12%] mb-[12%] py-20 min-h-[400px]">
        <div className="w-[92%] container mx-auto">
          <div className="flex justify-between text-3xl lg:text-4xl text-white mb-10 lg:mb-14">
      ...
      <div className="mt-[12%] mb-[12%] py-20 min-h-[400px]">
        <div className="w-[92%] container mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between space-y-6 lg:space-y-6 items-center flex-wrap ">
