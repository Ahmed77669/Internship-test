...
const ExamLevelsPage: React.FC = () => {
    ...
    return (
        <>
            <div className="flex flex-col items-center min-h-screen bg-white p-8  mt-[4%]">
                <h1 className="text-5xl font-bold mb-10 text-center text-[#094546]">Select Your Exam Level</h1>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8  mt-[4%]">
                    {levels.map((level) => (
                            ...
                            >
                                ...
                                <Link key={level.name} href={`/lessons/Levels/exam`} >
