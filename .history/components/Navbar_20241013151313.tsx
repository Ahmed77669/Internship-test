      ...
      <nav className="relative">
        <ul className="flex justify-between items-center">
          ...
          <div className="hidden md:flex mt-5 space-x-10">
            ...
            <button
              onClick={() => route("/")}
              className="bg-[#007676] text-white rounded-md w-[156px] h-[50px] text-[16px] font-semibold  py-1 px-5 transition-all duration-300 ease-in-out hover:bg-[#005555] hover:shadow-lg"
            >
              GET STARTED
            </button>
