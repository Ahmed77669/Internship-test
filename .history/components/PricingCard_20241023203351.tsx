...
const PricingCard: React.FC<PricingCardProps & ScriptLoaderProps> = ({ 
  plan, 
  price, 
  attempts, 
  features, 
  ...
  useEffect(() => {
    if (isScriptLoaded && isScriptLoadSucceed && window.FawryPay && window.DISPLAY_MODE) {
...
// Use asyncScriptLoader to load the FawryPay script
export default asyncScriptLoader('https://www.atfawry.com/assets/fawrypay-addons/fawrypay.js')(PricingCard);
