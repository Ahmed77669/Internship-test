...
const PricingCard: React.FC<PricingCardProps> = ({
  ...
  console.log(
    "fakjhfklafhhflalkhfkhal88888888888888888888888888888888888888888888"
  );
  useEffect(() => {
  ...
  const handlePayment = async (plan: string, price: number) => {
    ...
    if (window.FawryPay && window.DISPLAY_MODE) {
      window.FawryPay.checkout(chargeRequest, {
        locale: "en",
  ...
  return (
    <div
      className={`w-full max-w-sm p-6 bg-white border rounded-lg shadow-md transition-all duration-300 ${
        isPopular
