...
<div className="bg-black w-14 h-14 shadow-white shadow-lg items-center flex justify-center rounded-xl relative inset-x-[93%] -inset-y-[35%]">
  <Pen />
</div>
