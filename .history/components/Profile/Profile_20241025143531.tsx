  ...
  return (
    <section className="bg-gray-200 mb-28 ">
      <div className="flex justify-center container mx-auto">
        ...
        <div className="relative w-full h-[300px] mb-5 rounded-t-xl" style={{ 
  backgroundImage: "url('/popoo.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  backgroundRepeat: "no-repeat",
}}>
  <div className="bg-[#006767] w-14 h-14 shadow-black shadow-lg flex items-center justify-center rounded-xl absolute right-4 bottom-4 sm:right-6 sm:bottom-6 md:right-10 md:bottom-10 lg:right-12 lg:bottom-12 cursor-pointer">
    <Pen />
  </div>
</div>
...
<div className="flex flex-col items-center -mt-[100px] mb-10">
  ...
  />
<PlusCircle className="relative -inset-y-2 fill-gray-950 cursor-pointer"/>
