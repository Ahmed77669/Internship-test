  ...
  return (
    <section className="bg-gray-200 mb-28 ">
      <div className="flex justify-center container mx-auto">
        ...
        <div className="w-full h-[300px] mb-5 rounded-t-xl flex justify-end" style={{ 
  backgroundImage: "url('/popoo.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  backgroundRepeat: "no-repeat",
}}>
  <div className="bg-[#006767] w-14 h-14 shadow-black shadow-lg items-center flex justify-center rounded-xl cursor-pointer m-6">
  <Pen />
</div>
</div>
