    ...
    <section className="bg-gray-200 mb-28 ">
      <div className="flex justify-center container mx-auto">
        <div className="w-[1200px]  bg-white rounded-t-xl mt-8">
          ...
          >
<button className="bg-[#006767] w-14 h-14 shadow-black shadow-lg flex items-center justify-center rounded-xl cursor-pointer m-4 transition-all duration-200 active:scale-95 active:rounded-full active:bg-[#005656]">
  <Pen />
</button>
