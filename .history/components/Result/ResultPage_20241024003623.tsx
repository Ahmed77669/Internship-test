...
const CircularProgressWithLabel: React.FC<CircularProgressWithLabelProps> = ({ 
    ...
    return (
        <svg width={250} height={250} viewBox="0 0 250 250" className="w-full h-auto">
            <circle
                stroke="#d6d6d6"
                fill="transparent"
        ...
        <section className="px-4 text-black max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-start">
                <div className="flex flex-col items-center w-1/3 px-2">
                    ...
                    <p className="text-center text-sm sm:text-base md:text-xl lg:text-2xl mt-2">Duration</p>
                </div>
                <div className="flex flex-col items-center w-1/3 px-2">
                    <div className="w-[100px] sm:w-[150px] md:w-[200px] lg:w-[250px]">
                        <CircularProgressWithLabel 
                    ...
                    <p className="text-center text-sm sm:text-base md:text-xl lg:text-2xl mt-2">Final Result</p>
                </div>
                <div className="flex flex-col items-center w-1/3 px-2">
                    <div className="w-[100px] sm:w-[150px] md:w-[200px] lg:w-[250px]">
                        <CircularProgressWithLabel 
                    ...
                    <p className="text-center text-sm sm:text-base md:text-xl lg:text-2xl mt-2">Points</p>
                </div>
            </div>
