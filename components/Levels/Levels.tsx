            ...
            <div className="flex flex-col items-center min-h-screen bg-white p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    {levels.map((level) => (
                            ...
                            <div
                                key={level.name}
                                className={`rounded-xl shadow-xl p-8 flex flex-col justify-between items-center text-white transition-all duration-300 ease-in-out ${level.color} cursor-pointer border-2 border-white relative`}
